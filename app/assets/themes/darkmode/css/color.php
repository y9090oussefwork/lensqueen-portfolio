...
if (isset($_GET['primaryColor']) and $_GET['primaryColor'] != '') {
    ...
    $borderTop = hex2rgba("#" . $_GET['primaryColor'], 0.5);
} else {
    $themeColor = hex2rgba('#fd334c');
    $overlay1 = hex2rgba('#fd334c', 0.8);
    $borderTop = hex2rgba('#fd334c', 0.5);
}
?>


/*
Template Name : INVESTMENT HTML TEMPLATE;
Description: HTML5 / CSS3 / JQuery -- Multi Page
Author: Binary Operations Limited.
*/
...
i. HOMEPAGE
a) TOPBAR - BEFORE LOGIN
B) NAVBAR - BEFORE LOGIN
ii. LOGIN
iii. SIGN UP
iv. ABOUT
v. BLOG
...
viii. CONTACT
ix. DASHBOARD
a) TOPBAR - AFTER LOGIN
b) NAVBAR - AFTER LOGIN
x. FAQ
xi. INVESTOR
xii. OFFER-PLAN
xiii. PLAN
...
.card.secbg-6 .table td, .table th,
.card.secbg-6 .table thead th
{
border-top: 1px solid #ffffff1a;
border-bottom: 1px solid #ffffff1a;
}
...
.card.secbg .table-hover tbody tr {
border-left: 1px solid #ffffff1a;
border-right: 1px solid #ffffff1a;
border-bottom: 1px solid #ffffff1a;
...
.card.secbg-6 .table-hover tbody tr:hover {
background-color: #141b23;
color: #fff;
}
.card.secbg-6 .table-hover tbody tr td .title {
color: #0f83ff  !important;
}
.card.secbg-6 .table-hover tbody tr td .title:hover {
color: <?php echo  $themeColor;?> !important;
}
.card.secbg-6 .table-hover tbody tr td .btn:hover {
...
color: <?php echo $themeColor; ?>;
background:transparent;
border-color: <?php echo $themeColor; ?> <?php echo $themeColor; ?> <?php echo $themeColor; ?>;
}
...
@media screen and (min-width: 354px) and (max-width: 464px) {
.xs-dropdown-menu {
right: 0;
left: initial;
}
...
.dashboard__card {
background: linear-gradient(-45deg, #202b5d 0%, #131e51 100%);
padding: 30px;
border-radius: 10px;
align-items: center;
justify-content: space-between;
...
@media (max-width: 468px) {
    ...
    .account-dropdown.responsive-menus .dropdown-menu.show{
