...
@push('style')
    <style>
        .download-file .border-success:hover{
            ...
            <div class="tab-content mt-2" id="myTabContent">
                @foreach($languages as $key => $language)
                    ...
                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-tab-{{ $key }}" role="tabpanel">
                        <form method="post" action="{{ route('admin.productUpdate', [$id, $language->id]) }}" class="mt-4" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <div class="generate-btn-parent mb-3">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="text" name="title[{{ $language->id }}]"
                                                ...
                                                value="<?php echo old('title'.$language->id, isset($productDetails[$language->id]) ? @$productDetails[$language->id][0]->title : '') ?>">
                                    ...
                                    <div class="col-sm-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="tag[{{ $language->id }}]"
                                                ...
                                                value="<?php echo old('tag'.$language->id, isset($productDetails[$language->id]) ? @$productDetails[$language->id][0]->tag : '') ?>">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-12 col-md-6 mb-3">
                                        ...
                                        <input type="text" name="category[{{ $language->id }}]"
                                                ...
                                                value="<?php echo old('category'.$language->id, isset($productDetails[$language->id]) ? @$productDetails[$language->id][0]->category : '') ?>" data-role="tagsinput">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-12 col-md-12 mb-3">
                                        ...
                                        <input type="text" name="short_details[{{ $language->id }}]"
                                                ...
                                                value="<?php echo old('short_details'.$language->id, isset($productDetails[$language->id]) ? @$productDetails[$language->id][0]->short_details : '') ?>">
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="col-sm-12 col-md-12 mb-3">
                                        <div class="form-group ">
                                            ...
                                            <textarea class="form-control summernote @error('description'.'.'.$language->id) is-invalid @enderror" name="description[{{ $language->id }}]" id="summernote" rows="15" value="<?php echo old('description'.$language->id, isset($productDetails[$language->id]) ? @$productDetails[$language->id][0]->description : '') ?>">
                                    ...
                                    @if ($loop->index == 0)
                                            ...
                                            <div class="row justify-content-between align-items-center">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="file" name="product_file"
                                                           ...
                                                           value="{{getFile(config('location.product.path').(isset($productDetails[$language->id]) ? @$productDetails[$language->id][0]->product->product_file : ''))}}">
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="float-right download-file mt-4">
                                                        <a href="{{route('admin.productDownload',@$productDetails[$language->id][0]->product_id)}}"  class="btn mt-2 d-inline border-success">@lang('Download File'): <i class="fa fa-download text-success"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="image-input ">
                                                    ...
                                                    <img id="admin_image_preview_container" class="preview-image" src="{{ getFile(config('location.product.path').$productDetails[$language->id][0]->product->thumb) }}"
                                                         alt="preview image">
                                                </div>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input data-toggle="toggle" id="status" data-onstyle="success"
                                                   ...
                                                   type="checkbox" @if(@$productDetails[$language->id][0]->product->status) checked @endif name="status">
                                ...
                                @if ($loop->index == 0)
                                    <label class="mt-4"> @lang('Existing Product Images') : </label>
                                    <div class="row addedField" id="productGallery">
                                        @if($imageCount->image != null)
                                            @for($i = 0; $i<count($imageCount->image); $i++)
                                                <div class="col-sm-12 col-md-4 image-column">
                                                    <div class="form-group">
                                                            <div class="image-input position-relative z0">
                                                                <img id="image_preview_container" class="preview-image-product"	src="{{ getFile(config('location.product.path').@$imageCount->image[$i]) }}" alt="@lang('preview image')">
                                                            </div>


                                                                <button
                                                                    class="btn btn-danger notiflix-confirm removeFile z9"
                                                                    data-route="{{ route('admin.productImageDelete',[$imageCount->id,$imageCount->image[$i]]) }}"
                                                                    data-toggle="modal"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-6 mt-3 d-block">
                                            <div class="form-group">
                            ...
                            <button type="submit" class="btn waves-effect waves-light btn-rounded btn-primary btn-block mt-5">@lang('Save')</button>
                        </form>
                    </div>
                @endforeach
            </div>
