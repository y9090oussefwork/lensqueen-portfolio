...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <form method="post" action="{{route('admin.galleryStore')}}" class="form-row justify-content-center" enctype="multipart/form-data">
                @csrf
                <div class="col-md-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-input ">
                                ...
                                <img id="image_preview_container" class="preview-image"
                                    src="{{ getFile(config('location.gallery.path'))}}"
                ...
                <button type="submit" class="btn waves-effect waves-light btn-rounded btn-primary btn-block mt-3"><span><i class="fas fa-save pr-2"></i> @lang('Save')</span></button>
