                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>@lang('Website Logo')</label>
                                                <div class="image-input bg-dark">
                                                ...
                                                <span class="text-secondary">@lang('Logo Image') {{config('location.logoIcon.size')}}@lang('px')</span>
                                                @error('image')
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>@lang('Admin Panel Logo')</label>
                                                <div class="image-input">
                                                    <label for="image-upload" id="admin_image-label"><i
                                                            class="fas fa-upload"></i></label>
                                                    <input type="file" name="admin_image" placeholder="Choose image"
                                                           id="admin_image">
                                                ...
                                                <span class="text-secondary">@lang('Image size') {{config('location.logoIcon.size')}}@lang('px')</span>
                                                @error('admin_image')
                                                <span class="text-danger">{{$message}}</span>
                                                @enderror
                                            </div>
