                        ...
                        <td data-label="@lang('User')">
                            <a href="{{route('admin.user-edit', $row->user_id)}}">
                                <div class="d-flex no-block align-items-center">
                                    ...
                                    <div class="">
                                        <h5 class="text-dark mb-0 font-16 font-weight-medium">{{optional($row->user)->fullname}}</h5>
                                        <span class="text-muted font-14"><span>@</span>{{optional($row->user)->username}}</span>
                                    </div>
                                </div>
                            </a>
                        </td>
