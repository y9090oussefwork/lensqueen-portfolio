...
@section('content')
    ...
    <!--Enable Modal -->
    <div id="enableModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">

            <!-- Modal content-->
            <div class="modal-content form-block bg-dark">
                <div class="modal-header bg-dark">
                    <h5 class="modal-title">@lang('Verify Your OTP')</h5>
                    <button type="button" class="close text-white enableModal-button" data-dismiss="modal">&times;</button>
                ...
                <form action="{{route('user.twoStepEnable')}}" method="POST">
                    ...
                    <div class="modal-footer bg-dark">
                        <button type="button" class="btn btn-secondary enableModal-button" data-dismiss="modal">@lang('Close')</button>
    ...
    <!--Disable Modal -->
    <div id="disableModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-content form-block bg-dark">
                <div class="modal-header bg-dark">
                    ...
                    <button type="button" class="close disableModal-button" data-dismiss="modal">&times;</button>
                </div>
                <form action="{{route('user.twoStepDisable')}}" method="POST">
                    ...
                    <div class="modal-footer bg-dark">
                        <button type="button" class="btn btn-secondary disableModal-button" data-dismiss="modal">@lang('Close')</button>
                        <button type="submit" class="btn btn-success">@lang('Verify')</button>
                    </div>
                </form>
            </div>
...
@push('script')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.disableModal-button').on('click', function (e) {
                $("#disableModal").modal("hide");
            });

            $('.enableModal-button').on('click', function (e) {
