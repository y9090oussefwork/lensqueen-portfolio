                ...
                <div class="col-md-12">
                    ...
                    <div class="card bg-booking">
                        <div class="card-header text-center border-white">
                            <h5 class="card-title text-white text-22 p-3">@lang('Additional Information To Plan Confirm')</h5>
                        </div>

                        <div>
                            <div class="card-body">
                                <form action="{{route('user.booking.request.form.submit')}}" method="post" enctype="multipart/form-data" class="form-row text-left preview-form">
                                    @csrf
