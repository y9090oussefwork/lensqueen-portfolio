                ...
                <div class="navbar navbar-expand-md flex-wrap" id="pushNotificationArea">
                    <div class="d-flex">
                        ...
                        <a class="navbar-brand" href="{{route('home')}}">
                            <img src="{{getFile(config('location.logoIcon.path').'logo.png')}}" alt="@lang('homepage')">
                        </a>
                    </div>
                            ...
                            <div class="dropdown account-dropdown responsive-menus">
                                ...
                                <div class="xs-dropdown-menu dropdown-menu dropdown-right">
                                    <div class="dropdown-content">
                                        ...
                                        <a class="dropdown-item" href="{{route('services')}}">@lang('Services')</a>
                                        <a class="dropdown-item" href="{{route('blog')}}">@lang('Blog')</a>
                                        <a class="dropdown-item" href="{{route('gallery')}}">@lang('Gallery') </a>
                                        <a class="dropdown-item" href="{{route('product')}}">@lang('Shop') </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end justify-content-md-between"
                        ...
                        <ul class="navbar-nav d-none d-md-flex">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('gallery')}}">@lang('Gallery') </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('product')}}">@lang('Shop') </a>
                            </li>
                            <li class="nav-item">
