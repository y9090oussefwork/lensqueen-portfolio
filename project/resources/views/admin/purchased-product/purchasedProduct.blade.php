...
@section('title')
    @lang('User Purchased Product List')
@endsection
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('User')">
                                    ...
                                    <div class="d-flex no-block align-items-center">
                                        <div class="mr-3"><img src="{{ getFile(config('location.user.path').optional($item->user)->image)}}" alt="user" class="rounded-circle" width="45" height="45"></div>
                                        <div class="">
                                ...
                                <td data-label="@lang('Product')">
                                    <a href="{{route('admin.productEdit', $item->product_id)}}">
                                        @lang(optional($item->productDetails)->title)
                                    </a>
                                </td>
                                <td data-label="@lang('Price')">
                                    {{ $basic->currency_symbol ?? '$' }}{{getAmount($item->amount)}}
                                </td>
                                <td data-label="@lang('Purchased At')" class="">
