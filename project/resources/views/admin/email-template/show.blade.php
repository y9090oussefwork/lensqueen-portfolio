                ...
                <table id="zero_config"
                    ...
                    @foreach($emailTemplate as $template)
                        <tr>
                            ...
                            <td>
                                <a  href="{{ route('admin.email-template.edit',$template->id) }}" class="btn btn-sm btn-primary btn-rounded" title="@lang('Edit')"><i class="fas fa-edit" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
