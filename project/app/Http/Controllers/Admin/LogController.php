...
class LogController extends Controller
{
    ...
    {
        $transaction = Transaction::whereHas('user')->with('user')->orderBy('id', 'DESC')->paginate(config('basic.paginate'));
    ...
    public function transactionSearch(Request $request)
    {
        ...
        $transaction = Transaction::whereHas('user')->with('user')->orderBy('id', 'DESC')
